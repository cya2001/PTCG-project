...
import { useCartStore } from "@/components/shop/stores/cartStore";
    ...
    <div class="container" v-if="goods.categories">
      <div class="bread-container">
        <el-breadcrumb separator=">">
          ...
          <el-breadcrumb-item :to="{ path: `/shop/category/${goods.categories?.[1].id}` }">
            {{goods.categories?.[1].name}}
          </el-breadcrumb-item>
          <el-breadcrumb-item :to="{ path: `/shop/category/sub/${goods.categories?.[0].id}` }">
